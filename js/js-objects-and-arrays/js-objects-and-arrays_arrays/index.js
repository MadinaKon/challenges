...
const exampleArray = [33, "some random string"];

// EXERCISE 2
// Nest an array inside array nestedArray. After that nestedArray should contain an array as an element.

const parentArray = [33, "parent array"];
const nestedArray = [parentArray, 10, true];
...
console.log("fourth number of nestedNumbers ", nestedNumber);
